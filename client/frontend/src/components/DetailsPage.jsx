...
const DetailsPage = ({ data }) => {
  const tt = useT()
  if (!data) return <div>{tt('details.loading')}</div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">{tt('details.photos')}</h2>
      ...
      <div>
        <h2 className="text-2xl font-semibold mb-4">{tt('details.reviews')}</h2>
